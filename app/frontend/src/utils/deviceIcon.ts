...
export const DEVICE_COLORS: Record<Device['device_type'], string> = {
  ...
  moth_light_trap: notionColors.yellow.text,
};

export const DEVICE_TYPE_LABELS: Record<Device['device_type'], string> = {
...
/** MUI Chip colour per device type, matching the map marker colours. */
export const DEVICE_CHIP_COLORS: Record<
  Device['device_type'],
  'primary' | 'secondary' | 'success' | 'warning'
> = {
  camera_trap: 'primary',
  audio_recorder: 'secondary',
  refugia: 'success',
  moth_light_trap: 'warning',
};
...
export const DEVICE_SVG: Record<Device['device_type'], string> = {
  ...
  moth_light_trap: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 14C16.2144 13.0878 17 11.6356 17 10C17 7.23858 14.7614 5 12 5C9.23858 5 7 7.23858 7 10C7 11.6356 7.78563 13.0878 9 14C9.6494 14.4878 10 15.2693 10 16.0813V18C10 18.5523 10.4477 19 11 19H13C13.5523 19 14 18.5523 14 18V16.0813C14 15.2693 14.3506 14.4878 15 14Z"/><path d="M9.5 22H14.5"/></svg>`,
};
